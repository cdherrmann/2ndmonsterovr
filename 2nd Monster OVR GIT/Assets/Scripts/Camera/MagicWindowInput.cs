...
public class MagicWindowInput : MonoBehaviour
{
    ...
    void ResetRotation ()
    {
        transform.localRotation = Quaternion.Euler(90f, 0f, 0f) * Quaternion.Euler(90f, 0f, 0f) * Quaternion.Euler(0f, 180f, 180f);
    }
}