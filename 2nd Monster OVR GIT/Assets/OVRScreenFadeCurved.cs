...
public class OVRScreenFadeCurved : MonoBehaviour

{
    ...
    /// </summary>
    void OnLevelFinishedLoading(float timer)
    {
    ...
    void OnEnable()
    {
        ...
        SceneChanger.OnSceneStart += OnLevelFinishedLoading;
        SceneChanger.OnSceneChangeIssued += FadeOut;
    ...
    IEnumerator Fade(float startAlpha, float endAlpha)
    {
        ...
        while (elapsedTime < fadeTime)
        {
            ...
            currentAlpha = fadeCurve.Evaluate(currentAlpha);
            SetMaterialAlpha();
